...
RSpec.describe FamiliesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new family" do

        post :create, params: {family: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(family_url(Family.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new family" do
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the family" do
        family = Family.create! valid_attributes
